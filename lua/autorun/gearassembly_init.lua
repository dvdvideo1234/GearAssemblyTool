...
if(CLIENT) then -- con >> control, def >> default, hd >> header, lb >> label
  ...
  asmlib.SetLocalify("en","tool."..gsToolNameL..".friction_con"  , "Friction:")
  ...
  asmlib.SetLocalify("en","tool."..gsToolNameL..".deltarot_con"  , "Pivot finish:")
  ...
  asmlib.SetLocalify("en","tool."..gsToolNameL..".upspanchor"    , "Enable this to update the anchor for every spawn when not meshing")
  asmlib.SetLocalify("en","tool."..gsToolNameL..".upspanchor_con", "Non-mesh anchor update")
  ...
  asmlib.SetLocalify("bg","tool."..gsToolNameL..".upspanchor"    , "Включете за обновяване на опората готато създавате но не натрупвате")
  asmlib.SetLocalify("bg","tool."..gsToolNameL..".upspanchor_con", "Обновяване на опората при създаване")
