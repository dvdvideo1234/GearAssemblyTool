...
if(CLIENT) then -- con >> control, def >> default, hd >> header, lb >> label
  ...
  asmlib.SetLocalify("en","tool."..gsToolNameL..".upspanchor"    , "Enable this to update the anchor on every spawn when not meshing")
  asmlib.SetLocalify("en","tool."..gsToolNameL..".upspanchor_con", "Update anchor on trace")
  ...
  asmlib.SetLocalify("bg","tool."..gsToolNameL..".upspanchor"    , "Включете за обновяване на опората при всяко създаване без натрупвате")
  asmlib.SetLocalify("bg","tool."..gsToolNameL..".upspanchor_con", "Обнови опората при трасиране")
